...
% this are the values we obtained after seeding 32 infected individuals and
% running our model without isolation policies for 5 weeks.
...
% we split the population into isolation compartments and non-isolation compartments. 

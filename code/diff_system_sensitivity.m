function [x] = diff_system(t,y,theta,kappa,theta_s, kappa_s,new_patients,new_deaths,beta_input,epsilon_input)
...
% dS/dt
beta = beta_input; % probabilty of encounter with asymptomatic patient
epsilon = epsilon_input; % probabilty of encounter with symptomatic patient
